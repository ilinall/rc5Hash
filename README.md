# rc5Hash
Этот проект представляет собой реализацию хэширования на основе блочного шифра RC5. Включает в себя функцию для генерации случайного ключа, шифрования блоков с использованием RC5, и соответственно хэширования сообщений (хэш возвращается в виде 8-значного шестнадцатеричного числа)
